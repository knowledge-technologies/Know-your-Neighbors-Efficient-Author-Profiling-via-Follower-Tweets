...
def build_dataframe(data_docs):
    ...
    #df_data['no_punctuation'] = df_data['text'].progress_map(lambda x: remove_punctuation(x))
    #print("no_punctuation")
    #df_data['no_stopwords'] = df_data['no_punctuation'].progress_map(lambda x: remove_stopwords(x))
    #print("no_stopwords")
    #df_data['text_clean'] = df_data['text']
    #print("text_clean")
    #df_data['pos_tag_seq'] = df_data['text_clean'].progress_map(lambda x: get_pos_tags(x))
    #print("pos_tag_seq")    
    df_data = pd.DataFrame({'text': data_docs})        
